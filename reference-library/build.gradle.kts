...
mavenPublishing {
  ...
  pom {
    name = "OHS Player Reference Client Library"
    description =
      "A Kotlin Multiplatform library for rendering configuration-driven FHIR views with Compose"
    inceptionYear = "2026"
    url = "https://github.com/ohs-foundation/ohs-player-reference-client-library"
    licenses {
      license {
    ...
    scm {
      url = "https://github.com/ohs-foundation/ohs-player-reference-client-library/"
      connection = "scm:git:git://github.com/ohs-foundation/ohs-player-reference-client-library.git"
      developerConnection =
        "scm:git:ssh://git@github.com/ohs-foundation/ohs-player-reference-client-library.git"
    }
  }
}
