 ...
 */
package dev.ohs.player.reference.library.layout
...
import dev.ohs.player.reference.library.renderer.LayoutRenderer
 ...
 * [dev.ohs.player.reference.library.scaffold.ListScaffold] when none is specified.
 *
 * View-type constants are typically declared once in an `object`; see
 * [dev.ohs.player.reference.library.registry.ViewType].
 *
 * ```
 * object AppViewTypes {
...
class VerticalListRenderer<T>(
  ...
  companion object {
     ...
     * [dev.ohs.player.reference.library.registry.ViewRegistry].
     */
